...
export class CreateDatabase1700789043734 implements MigrationInterface {
    name = 'CreateDatabase1700789043734'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "events" ("id_event" uuid NOT NULL, "type_id" uuid NOT NULL, "name" character varying NOT NULL, "location" character varying NOT NULL, "date" date NOT NULL, "time" TIME NOT NULL, "finish_date" date NOT NULL, "finish_time" TIME NOT NULL, "actived" boolean NOT NULL DEFAULT true, "additional" character varying, "drink_preferences" character varying, "min_amount" integer, "tickets_free" integer NOT NULL DEFAULT '0', "ticket_value" integer NOT NULL DEFAULT '0', "club_name" character varying, "performer" character varying, "cover_photo" character varying, "private" boolean NOT NULL DEFAULT false, "tags" character varying array NOT NULL, "author_id" uuid NOT NULL, "address_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_72a0a3c62df3f106392cdfd510d" PRIMARY KEY ("id_event"))`);
