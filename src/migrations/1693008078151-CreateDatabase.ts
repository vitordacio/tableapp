...
export class CreateDatabase1693008078151 implements MigrationInterface {
    name = 'CreateDatabase1693008078151'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "friendships" ("id_friendship" uuid NOT NULL, "sender_id" uuid NOT NULL, "receiver_id" uuid NOT NULL, "accepted" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_8e6a67aaca37c514f4d5eb6d031" PRIMARY KEY ("id_friendship"))`);
        await queryRunner.query(`CREATE TABLE "notifications" ("id_notification" uuid NOT NULL, "message" character varying NOT NULL, "read" boolean NOT NULL DEFAULT false, "type" character varying NOT NULL, "user_id" uuid NOT NULL, "sent_by" uuid, "friendship_id" uuid, "participation_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_aeb74360cf6bc2b15d19ff1c15e" PRIMARY KEY ("id_notification"))`);
        await queryRunner.query(`CREATE TABLE "participations" ("id_participation" uuid NOT NULL, "type" character varying NOT NULL, "in" boolean NOT NULL DEFAULT false, "confirmed_by_user" boolean NOT NULL DEFAULT true, "confirmed_by_event" boolean NOT NULL DEFAULT false, "reviwed_by_user" boolean NOT NULL DEFAULT true, "reviwed_by_event" boolean NOT NULL DEFAULT false, "user_id" uuid NOT NULL, "reviwer_id" uuid, "event_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_9a903774221e8c192b899560423" PRIMARY KEY ("id_participation"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id_user" uuid NOT NULL, "email" character varying NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "name" character varying NOT NULL, "phone" character varying, "avatar" character varying, "role_name" character varying NOT NULL DEFAULT 'user', "private" boolean NOT NULL DEFAULT false, "CNPJ" character varying, "age" integer, "gender" character varying, "google_id" character varying, "friends" integer NOT NULL DEFAULT '0', "address_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "REL_1b05689f6b6456680d538c3d2e" UNIQUE ("address_id"), CONSTRAINT "PK_fbb07fa6fbd1d74bee9782fb945" PRIMARY KEY ("id_user"))`);
        await queryRunner.query(`CREATE TABLE "events" ("id_event" uuid NOT NULL, "type" character varying NOT NULL, "name" character varying NOT NULL, "location" character varying NOT NULL, "date" date NOT NULL, "time" TIME NOT NULL, "finish_date" date NOT NULL, "finish_time" TIME NOT NULL, "actived" boolean NOT NULL DEFAULT true, "additional" character varying, "club_name" character varying, "performer" character varying, "drink_preferences" character varying, "img_url" character varying, "age_limit" integer NOT NULL DEFAULT '0', "free_ticket" integer NOT NULL DEFAULT '0', "private" boolean NOT NULL DEFAULT false, "owner_id" uuid NOT NULL, "address_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "REL_ccc95d911d2b1e4ea171923893" UNIQUE ("address_id"), CONSTRAINT "PK_72a0a3c62df3f106392cdfd510d" PRIMARY KEY ("id_event"))`);
        await queryRunner.query(`CREATE TABLE "addresses" ("id_address" uuid NOT NULL, "zip" character varying, "street" character varying, "uf" character varying, "city" character varying, "district" character varying, "number" character varying, "lat" numeric(10,6), "long" numeric(10,6), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_5cc63ead447e5007e73ee0ceadb" PRIMARY KEY ("id_address"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_1b05689f6b6456680d538c3d2ea" FOREIGN KEY ("address_id") REFERENCES "addresses"("id_address") ON DELETE NO ACTION ON UPDATE NO ACTION`);
