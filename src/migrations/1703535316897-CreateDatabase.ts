...
export class CreateDatabase1703535316897 implements MigrationInterface {
    name = 'CreateDatabase1703535316897'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notifications" ("id_notification" uuid NOT NULL, "message" character varying NOT NULL, "read" boolean NOT NULL DEFAULT false, "type" character varying NOT NULL, "user_id" uuid NOT NULL, "author_id" uuid NOT NULL, "friendship_id" uuid, "emoji_id" uuid, "participation_id" uuid, "achievement_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_aeb74360cf6bc2b15d19ff1c15e" PRIMARY KEY ("id_notification"))`);
