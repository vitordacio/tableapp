...
export class CreateDatabase1703881607948 implements MigrationInterface {
    name = 'CreateDatabase1703881607948'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "artists" ("id_block" uuid NOT NULL, "author_id" uuid NOT NULL, "receiver_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_8b82d99e16cb146abc41b73ddad" PRIMARY KEY ("id_block"))`);
        ...
        await queryRunner.query(`ALTER TABLE "artists" ADD CONSTRAINT "FK_7d5c98230f85e8c38e8ccc87b8a" FOREIGN KEY ("author_id") REFERENCES "users"("id_user") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "artists" ADD CONSTRAINT "FK_53c2133bfe3f3931adf7f07fe9d" FOREIGN KEY ("receiver_id") REFERENCES "users"("id_user") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "artists" DROP CONSTRAINT "FK_53c2133bfe3f3931adf7f07fe9d"`);
        await queryRunner.query(`ALTER TABLE "artists" DROP CONSTRAINT "FK_7d5c98230f85e8c38e8ccc87b8a"`);
