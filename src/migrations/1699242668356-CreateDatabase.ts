...
export class CreateDatabase1699242668356 implements MigrationInterface {
    name = 'CreateDatabase1699242668356'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "friendships" ("id_friendship" uuid NOT NULL, "sender_id" uuid NOT NULL, "receiver_id" uuid NOT NULL, "confirmed" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_8e6a67aaca37c514f4d5eb6d031" PRIMARY KEY ("id_friendship"))`);
