...
export class CreateDatabase1700448513004 implements MigrationInterface {
    name = 'CreateDatabase1700448513004'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "social_network_types" ("id_social_network_type" uuid NOT NULL, "type" character varying NOT NULL, "base_url" character varying NOT NULL, "deep_link" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_b329127691a12ba4e7ef76b1259" UNIQUE ("type"), CONSTRAINT "PK_dcaeea2a15b0c4a9503856f62a5" PRIMARY KEY ("id_social_network_type"))`);
